...
if (isset($_POST['add'])) {
    ...
    $sql_dish_edit = "UPDATE Dishes SET name='$name', price='$price', description='$description', image_path='$target_file' WHERE id = '$dish_id'";
    $result = mysqli_query($link, $sql_dish_edit);
